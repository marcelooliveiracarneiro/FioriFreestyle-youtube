class ZCL_ZSHP_GW_OV_MPC definition
  public
...
TT_OVHEADER type standard table of TS_OVHEADER .
  ...
  begin of TS_OVITEM,
     ...
     QUANTIDADE type P length 8 decimals 2,
     PRECOUNU type P length 8 decimals 2,
...
TT_MENSAGEM type standard table of TS_MENSAGEM .
  ...
  constants GC_OVHEADER type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'OVHeader' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSHP_GW_OV_MPC============CP' ##NO_TEXT.

  methods DEFINE_OVHEADER
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
...
CLASS ZCL_ZSHP_GW_OV_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSHP_GW_OV_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            iv_association_name = 'OVHeaderToOVItem' "#EC NOTEXT
                            iv_left_type        = 'OVHeader' "#EC NOTEXT
                            iv_right_type       = 'OVItem' "#EC NOTEXT
                            iv_right_card       = 'N' "#EC NOTEXT
                            iv_left_card        = '1'  "#EC NOTEXT
                            iv_def_assoc_set    = abap_false ). "#EC NOTEXT
* Referential constraint for association - OVHeaderToOVItem
lo_ref_constraint = lo_association->create_ref_constraint( ).
lo_ref_constraint->add_property( iv_principal_property = 'OrdemId'   iv_dependent_property = 'OrdemId' ). "#EC NOTEXT
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'OVHeaderToOVItemSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'OVHeaderSet'              "#EC NOTEXT
...
* Navigation Properties for entity - OVHeader
lo_entity_type = model->get_entity_type( iv_entity_name = 'OVHeader' ). "#EC NOTEXT
lo_nav_property = lo_entity_type->create_navigation_property( iv_property_name  = 'OVHeaderToOVItemNav' "#EC NOTEXT
                                                              iv_abap_fieldname = 'OVHEADERTOOVITEMNAV' "#EC NOTEXT
                                                              iv_association_name = 'OVHeaderToOVItem' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSHP_GW_OV_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'OVHeader' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSHP_GW_OV_MPC=>TS_OVHEADER' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'OVHeaderSet' ). "#EC NOTEXT
...
lo_property->/iwbep/if_mgw_odata_annotatabl~create_annotation( 'sap' )->add(
      EXPORTING
        iv_key      = 'unicode'
        iv_value    = 'false' ).
lo_property = lo_entity_type->create_property( iv_property_name = 'PrecoUnu' iv_abap_fieldname = 'PRECOUNU' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSHP_GW_OV_MPC=>TS_OVITEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20240809090726'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'OVHeader'.                            "#EC NOTEXT
...
APPEND ls_text_element TO rt_text_elements.
clear ls_text_element.
ls_text_element-artifact_name          = 'PrecoUnu'.                 "#EC NOTEXT
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'OVItem'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
